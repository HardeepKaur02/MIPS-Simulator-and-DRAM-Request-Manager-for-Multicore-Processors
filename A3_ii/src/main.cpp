...
public:
  ...
  void activate(int row_num){
      ...
      int start = cycle_num + 1;
      cycle_num+= row_access_delay;
      cout<<endl<<"CYCLE NUM : "<<start<<" - "<<cycle_num<<endl;
      cout<<"INSTRUCTION : DRAM - Activate row "<<row_num<<endl;
  ...
  void writeback(int row_num){
      ...
      cycle_num+= row_access_delay;
      cout<<endl<<"CYCLE NUM : "<<start<<" - "<<cycle_num<<endl;
      cout<<"INSTRUCTION : DRAM - Writeback row "<<row_num<<endl;
  ...
  word col_req1(int col_num){     ///load word
      ...
      int start = cycle_num + 1;
      cycle_num+= col_access_delay;
      cout<<endl<<"CYCLE NUM : "<<start<<" - "<<cycle_num<<endl;
      cout<<"INSTRUCTION : DRAM - Column Access "<<endl;
      return temp;
  }
  ...
  void col_req2(int row_num, int col_num, word store_it){
    ...
    cycle_num+= col_access_delay;
    cout<<endl<<"CYCLE NUM : "<<start<<" - "<<cycle_num<<endl;
    cout<<"INSTRUCTION : DRAM - Column Access "<<row_num<<endl;
    cout<<"Row bufffer updated\n";
  }
...
void interpret(ALU& my_ALU, Memory& my_mem, RF& RegFile, vector<int>& ins_counts){
    ...
    string ins_name = name(operator_temp);
    cout<<"INSTRUCTION : "<<ins_name<<endl;
